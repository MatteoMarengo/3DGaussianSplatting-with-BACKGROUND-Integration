...
def training(background_image_path, dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    first_iter = 0
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        # print("image shape: ", image.shape)
        # plt.imsave("GT_NUS_background.png", gt_image.detach().cpu().numpy())
